...
/* pin     port             bit   pwm       icp      */ \
  ...
  [ 2] = { PIN_TYPE_NC,       0,  OCP_NONE, ICP_NONE }, \
  [ 3] = { PIN_TYPE_NC,       0,  OCP_NONE, ICP_NONE }, \
  [ 4] = { PIN_TYPE_NC,       0,  OCP_NONE, ICP_NONE }, \
  [ 5] = { PIN_TYPE_NC,       0,  OCP_NONE, ICP_NONE }, \
  [ 6] = { PIN_TYPE_NC,       0,  OCP_NONE, ICP_NONE }, \
  [ 7] = { PIN_TYPE_NC,       0,  OCP_NONE, ICP_NONE }, \
  [ 8] = { PIN_TYPE_NC,       0,  OCP_NONE, ICP_NONE }, \
  [ 9] = { PIN_TYPE_NC,       0,  OCP_NONE, ICP_NONE }, \
  [10] = { PIN_TYPE_NC,       0,  OCP_NONE, ICP_NONE }, \
  [11] = { PIN_TYPE_NC,       0,  OCP_NONE, ICP_NONE }, \
  [12] = { PIN_TYPE_NC,       0,  OCP_NONE, ICP_NONE }, \
  [13] = { PIN_TYPE_OUTPUT,   0,  OCP_NONE, ICP_NONE }, \
  [14] = { PIN_TYPE_NC,       0,  OCP_NONE, ICP_NONE }, \
  [15] = { PIN_TYPE_NC,       0,  OCP_NONE, ICP_NONE }, \
  [16] = { PIN_TYPE_NC,       0,  OCP_NONE, ICP_NONE }, \
  [17] = { PIN_TYPE_NC,       0,  OCP_NONE, ICP_NONE }, \
  [18] = { PIN_TYPE_NC,       0,  OCP_NONE, ICP_NONE }, \
  [19] = { PIN_TYPE_NC,       0,  OCP_NONE, ICP_NONE }, \
  [20] = { PIN_TYPE_NC,       0,  OCP_NONE, ICP_NONE }, \
  [21] = { PIN_TYPE_NC,       0,  OCP_NONE, ICP_NONE }, \
  [22] = { PIN_TYPE_NC,       0,  OCP_NONE, ICP_NONE }, \
  [23] = { PIN_TYPE_NC,       0,  OCP_NONE, ICP_NONE }, \
  [24] = { PIN_TYPE_NC,       0,  OCP_NONE, ICP_NONE }, \
  [25] = { PIN_TYPE_NC,       0,  OCP_NONE, ICP_NONE }, \
  [26] = { PIN_TYPE_NC,       0,  OCP_NONE, ICP_NONE }, \
  [27] = { PIN_TYPE_NC,       0,  OCP_NONE, ICP_NONE }, \
  [28] = { PIN_TYPE_NC,       0,  OCP_NONE, ICP_NONE }, \
  [29] = { PIN_TYPE_NC,       0,  OCP_NONE, ICP_NONE }, \
  [30] = { PIN_TYPE_NC,       0,  OCP_NONE, ICP_NONE }, \
  [31] = { PIN_TYPE_NC,       0,  OCP_NONE, ICP_NONE }, \
